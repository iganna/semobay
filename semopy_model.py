import numpy as np
from semopy_percer import SEMParser
...
class SEMData:
    def __init__(self, sem, file_name, center=True):
        ...
        self.m_profiles = get_profiles(sem, file_name, center)
...
class SEMModel:
    ...
    def get_matrices(self, params=None):  # TODO only pass parameters through
        """
        ...
        if params is not None:
            ...
            pass  # Set and automatic update of matrices

        # The returned matrices are updated
        return self.matrices

    def check_for_validity(self, output=stdout):
    ...
    def load_initial_dataset(self, data: SEMData):
        ...
        for i, position in self.param_pos.items():
            ...
            # # TODO possible initial value
            # if v_spart[pos1] in v_lat:
            #     continue
            # if v_spart[pos2] in v_lat:
            #     continue
            #
            # pos1 = d_mpart[v_spart[pos1]]
            # pos2 = d_mpart[v_spart[pos2]]
            #
            # self.param_val[i] = m_cov[pos1][pos2]/2
